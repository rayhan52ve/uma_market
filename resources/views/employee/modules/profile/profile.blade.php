         ...
         <div class="col-md-8">
          <div class="card">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-primary " href="{{route('employee.editProfile',auth()->user()->id)}}">@changeLang('Edit')</a>            
                <a class="btn btn-danger" href="{{route('password')}}">@changeLang('Change Password')</a>            
               </div>
          </div>
       </div>
       </div>
