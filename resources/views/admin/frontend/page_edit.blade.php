                        ...
                        <form action="" method="POST" class="col-md-12">
                            ...
                            <div class="row">
                                    ...
                                    <ol class="simple_with_drop vertical section_style draggable-area ">
                                        @if ($page->sections != null)
                                            ...
                                            @foreach ($page->sections as $section)
                                                ...
                                                <li class="highlight icon-move clearfix w-45" data-item="{{$section}}">
                                                    <i class=" fa fa-arrows-alt text-white mt-2"></i>
                                                    <span
                                                        class="d-inline-block  mr-auto ml-2 mt-2">{{ $section . ' Section' }}</span>
                                ...
                                <div class="form-group col-md-6 {{$page->name == 'home' ? 'd-none' :''}}">
                                    ...
                                    <input type="text" name="page" class="form-control" required value="{{$page->name}}">

                                </div>

                                 <div class="form-group {{$page->name == 'home' ? 'col-md-12' :'col-md-6'}}">

                                    <label for="">@changeLang('Page Order')</label>

                                    <input type="text" name="page_order" class="form-control" value="{{$page->page_order}}">
                                 ...
                                 <div class="form-group col-md-6 {{$page->name == 'home' ? 'd-none' :''}}">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="1" {{$page->status ? 'selected' : ''}}>@changeLang('Active')</option>
                                        <option value="0" {{$page->status ? '' : 'selected'}}>@changeLang('Inactive')</option>
                                ...
                                <div class="form-group col-md-6 {{$page->name == 'home' ? 'd-none' :''}}">
                                   ...
                                   <select name="dropdown" class="form-control">
                                        ...
                                        <option value="1" {{$page->is_dropdown ? 'selected' : ''}}>@changeLang('Yes')</option>
                                        <option value="0" {{$page->is_dropdown ? '' : 'selected'}}>@changeLang('No')</option>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="seo_description" id="" cols="30" rows="5"
                                        class="form-control">{{ $page->seo_description ?? old('seo_description') }}</textarea>

                                </div>


                                 <div class="form-group col-md-12 custom-section {{$page->custom_section_data != null ?'':'d-none'}}">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary">@changeLang('Update Page')</button>
                                </div>
