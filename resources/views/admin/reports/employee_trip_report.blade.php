...
<head>
    ...
    <title>Employee Trip Sale Report</title>
</head>
        ...
        <div class="card-header">
            ...
            <div class="card-header-form">
                ...
                <div class="d-flex justify-content-end">
                    <form method="GET" action="{{ route('admin.employeeTripReport.search') }}">
                        <div class="input-group ">
                            <select name="search" class="form-control form-select" required>
                                <option selected disabled>Select Employee</option>
                                @foreach ($employees as $employee)
                                    <option class="text-dark" value="{{ $employee->id }}">{{ $employee->fullname }}
                                    </option>
                                @endforeach
                            </select>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                @forelse ($all_trips['daily'] as $all_trip)
                                                    <tr class="text-left">
                                                        ...
                                                        <td> {{ __($all_trip->customer->created_by) }}</td>
