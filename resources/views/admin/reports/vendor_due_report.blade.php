    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-form">
                ...
                {{-- <div class="d-flex justify-content-end" id="dailyPaymentDue">
                    <form method="GET" action="{{ route('admin.dailydueReport.search') }}">
            ...
            <div class="card">
                {{-- <div class="card-header">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item">
                            @if ($search)
                                {{ \Carbon\Carbon::parse($search)->format('d-m-Y') }} তারিখের বাকি পেমেন্ট
                            @else
                                সকল বাকি পেমেন্ট
                            @endif
                                            ...
                                            <tbody>
                                                @forelse ( $providers as $provider)
                                                    <tr class="text-left">
                                                        ...
                                                        <td> {{ __($provider->fname) }}</td>
                                                        <td> {{ __($provider->biddings->count()) }}</td>
                                                        <td> {{ __(@$provider->biddings_sum_bid_amount) }}</td>
