                        ...
                        <form action="{{ route('admin.employee.store') }}" method="POST">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="w-50">
                                        <input autocomplete="off" type="text" value="{{ old('username') }}"
                                            class="form-control" name="username" placeholder="@changeLang('User Name')" required>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="w-50">
                                        <select id="has_agent_id" name="employee_role" class="form-control form-select"
                                            required>
                                            <option selected>@changeLang('Select Role')</option>
                                            <option class="text-dark" value="Zone Manager">@changeLang('Zone Manager')</option>
                                            <option class="text-dark" value="Team Leader">@changeLang('Team Leader')</option>
                                            <option class="text-dark" value="Brand Promoter">@changeLang('Brand Promoter')</option>
                                        </select>
                                        @error('has_agent_id')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <tr>
                                    <td class="w-50">@changeLang('Address')<span class="text-danger">*</span></td>
                                    <td class="">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <select id="division" name="division_id" class="form-control form-select"
                                                    value="{{ old('division_id') }}" required>
                                                    <option selected disabled>@changeLang('Select Division')<span class="text-danger">*</span>
                                                    </option>
                                ...
                                <tr>
                                    <td class="w-50">@changeLang('Employees Referral Code')<span class="text-danger">*</span></td>
                                    <td class="w-50">
                                        <input type="text" value="{{ old('referral') }}" class="form-control"
                                            name="referral" placeholder="@changeLang('Employees Referral Code')" required>
                                        @error('referral')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="w-50">
                                        <input type="password" class="form-control" name="password"
                                            placeholder="@changeLang('Password')" required>
                                        @error('password')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                            ...
                            <button type="submit" class="btn btn-primary">@changeLang('Add Employee')</button>
                        </form>
                    </div>
                </div>
            </div>
