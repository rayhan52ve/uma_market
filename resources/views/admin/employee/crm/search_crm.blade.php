...
@section('content')
    <div class="row">
        <div class="col-md-12">
            {{-- <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        <form method="GET" action="{{ route('admin.employee_crm.search') }}">
                            <div class="row">
            ...
            <div class="card mt-2 mx-auto bg-gradient-secondary " style="width: 30rem;">
                <div class="card-body">
                    @if ($employee)
                        <div class="text-center">
                            <h6 class="card-title"><b>@changeLang('Employee Details')</b></h6>
                        </div>
                        ...
                        <p class="card-text"><b>@changeLang('Location') : </b>
                            {{ __($employee->division->bn_name) }},{{ __(@$employee->district->bn_name) }},{{ __(@$employee->upazila->bn_name) }}
                        </p>
                    @else
                ...
                <div class="card">
                        ...
                        <ul class="nav nav-pills" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="current_trips_tab" data-toggle="tab" href="#current_trips"
                                    role="tab" aria-controls="current_trips" aria-selected="false">@changeLang('Current Trips')</a>
                            </li>
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="current_trips" role="tabpanel"
