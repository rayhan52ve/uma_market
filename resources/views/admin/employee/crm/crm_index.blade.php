...
@section('breadcrumb')
    <section class="section">
        <div class="section-header">
            ...
            @endif --}}
            <h1>@changeLang('Employees CRM')</h1>
        </div>
    </section>
@endsection
@section('content')
                    ...
                    <div class="card-header-form">
                        <form method="GET" action="{{ route('admin.employee_crm.search') }}">
                            <div class="input-group">
                                <input type="text" class="form-control" name="search" placeholder="Enter Referral Code">
                            ...
                            <tbody>
                                @forelse($employees as $key => $employee)
                                    <tr>
                                        ...
                                        <td>{{ __(@$employee->division->name,) }}, {{@$employee->district->name}}, {{@$employee->upazila->name}}, {{@$employee->union->name}}</td>
                                        <td>
                                            @if ($employee->status)
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('admin.employee_crm.view',$employee->id) }}" class="btn btn-info mr-2"><i class="fa fa-eye"></i></a>
