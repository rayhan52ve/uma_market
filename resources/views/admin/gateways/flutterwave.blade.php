...
@section('breadcrumb')
 <section class="section">
          <div class="section-header">
            ...
            <h1>@changeLang('Flutterwave Payment Gateway')</h1>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">@changeLang('Flutterwave Image')</label>

                                <div id="image-preview" class="image-preview"
                                    style="background-image:url({{ getFile('gateways' , @$flutterwave->logo) }});">
                                    <label for="image-upload" id="image-label">@changeLang('Choose File')</label>
                                    <input type="file" name="flutterwave_image" id="image-upload" />
                                </div>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="">@changeLang('Title')</label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="" class="form-control">
                                                <option {{ $flutterwave->status==1 ? 'selected':'' }} value="1">@changeLang('Active')</option>
                                                <option {{ $flutterwave->status==0 ? 'selected':'' }} value="0">@changeLang('Inactive')</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100">@changeLang('Update Flutterwave Information')</button>
