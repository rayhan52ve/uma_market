...
@section('breadcrumb')
 <section class="section">
          <div class="section-header">
            ...
            <h1>@changeLang('Paystack Payment Gateway')</h1>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">@changeLang('Paystack Image')</label>

                                <div id="image-preview" class="image-preview"
                                    style="background-image:url({{ getFile('gateways' , @$paystack->image) }});">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="public_key" value="{{ $paystack->public_key }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="secret_key" value="{{ $paystack->secret_key }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $paystack->currency_rate }}" name="currency_rate">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="" class="form-control">
                                                <option {{ $paystack->status==1 ? 'selected':'' }} value="1">@changeLang('Active')</option>
                                                <option {{ $paystack->status==0 ? 'selected':'' }} value="0">@changeLang('Inactive')</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100">@changeLang('Update Paystack Information')</button>
