...
@section('breadcrumb')
    <section class="section">
        ...
        <div class="section-header d-flex justify-content-between">
            ...
            <h1>@changeLang('All withdraws')</h1>
            </h1>
                        ...
                        <table class="table table-striped">
                            ...
                            @forelse ($withdrawlogs as $key => $withdrawlog)
                                <tr>
                                    ...
                                    <td>
                                        {{ number_format($withdrawlog->charge, 4) }}
                                    </td>


                                    <td>
                                        {{ number_format($withdrawlog->balance_remains, 4) }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-primary details"
                                            data-user_data="{{ json_encode($withdrawlog->user_data) }}"
                                            data-withdraw="{{ $withdrawlog }}">@changeLang('Details')</button>
