            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner-text">
                        <h1>@changeLang('Verify Account')</h1>
                        <ul>
                            <li><a href="{{ route('home') }}">@changeLang('Home')</a></li>
                            <li><span>@changeLang('Verify Account')</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('user.auth.verify') }}" method="POST">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <label for="">@changeLang('Verify Code')</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn  btn-base ">@changeLang('Verify Now')</button>
                                </div>
